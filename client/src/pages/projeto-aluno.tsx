...
export default function VisualizarComoAluno() {
  const [match, params] = useRoute("/projeto-aluno/:id");
                ...
                <div className="mt-8 bg-black bg-opacity-30 backdrop-blur-sm rounded-2xl p-6 max-w-5xl mx-auto">
                  ...
                  <div className="flex justify-center">
                    <img
                      ...
                      className="max-h-96 w-auto rounded-xl border-2 border-white border-opacity-30 shadow-2xl"
                    />
                  </div>
                </div>
              )}
