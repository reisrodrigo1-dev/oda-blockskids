...
// --- NOVA VERSÃO: Layout e funcionalidades iguais ao editor público ---
import { useState, useEffect } from "react";

// Gradientes e ícones iguais ao editor público
const gradientes = [
          ...
          <div className="max-w-4xl mx-auto py-12 px-4">
            ...
            <Card className="mb-8 bg-gray-800/50 border-gray-700 backdrop-blur">
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">🖼️ URL da Imagem dos Blocos (opcional)</label>
                  <Input
